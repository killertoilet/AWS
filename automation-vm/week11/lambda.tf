...
#      "arn:aws:logs:us-east-1:422113805477:*"
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:us-east-1::log-group:/aws/lambda/week11-lambda:*"
#      "arn:aws:logs:us-east-1:422113805477:log-group:/aws/lambda/week11-lambda:*"
    ]
  }
...
#      "arn:aws:ec2:us-east-1:422113805477:instance/*"
    ]
  }
