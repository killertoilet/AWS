...
#      "arn:aws:logs:us-east-1:422113805477:*"
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:us-east-1::log-group:/aws/lambda/week13-lambda:*"
#      "arn:aws:logs:us-east-1:422113805477:log-group:/aws/lambda/week13-lambda:*"
    ]
  }
...
# cbb	"secretmanager:ListSecrets"
    ...
    resources = [
# cbb	"*"
        aws_secretsmanager_secret.week13-secret.arn  # cbb
	]
  }
}
