...
#      "arn:aws:logs:us-east-1:422113805477:*"
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:us-east-1::log-group:/aws/lambda/week7-lambda:*"
#      "arn:aws:logs:us-east-1:422113805477:log-group:/aws/lambda/week7-lambda:*"
    ]
  }
